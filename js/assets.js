...
const AssetsModule = {
  ...
  _validateImportRows(json) {
    ...
    return { validRows, invalidRecords, warnings, totalEmpty: 0, totalReceived: validRows.length + invalidRecords.length, totalInvalid: invalidRecords.length, totalValid: validRows.length };
  },
